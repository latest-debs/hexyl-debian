...
[![Release](https://img.shields.io/github/v/release/latest-debs/hexyl-debian)](https://github.com/latest-debs/hexyl-debian/releases)
[![Build](https://github.com/latest-debs/hexyl-debian/actions/workflows/release.yml/badge.svg)](../../actions)

[hexyl](https://github.com/sharkdp/hexyl) — a command-line hex viewer — packaged for
...
Or download a `.deb` from the [Releases](https://github.com/latest-debs/hexyl-debian/releases) page:

```sh
sudo apt install ./hexyl_*.deb
```

## Verify

```sh
apt-cache policy hexyl
hexyl --version
```
...
Run the [Build hexyl for Debian](../../actions) workflow on GitHub with the
...
For issues with hexyl itself, see
[hexyl](https://github.com/sharkdp/hexyl).

## License

Packaging scripts in this repo are MIT-licensed. The packaged binaries
remain under their upstream license — see [hexyl](https://github.com/sharkdp/hexyl).
